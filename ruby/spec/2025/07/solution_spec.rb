...
RSpec.describe Year2025::Day07 do
  ...
  let(:example_input) { File.read(File.join(File.dirname(__FILE__), "../../../challenges/2025/07/example.txt")) }
  ...
  describe "part 1" do
    ...
    it "returns nil for my input" do
      expect(described_class.part_1(input)).to eq(1546)
    end
  end
  ...
  describe "part 2" do
    ...
    it "returns nil for my input" do
      expect(described_class.part_2(input)).to eq(13883459503480)
    end
  end
end
